...
export default function FeatureGrid({ dict }: { dict: Dictionary['features'] }) {
    ...
    <section id="features" className="py-20 md:py-28 px-6 bg-bg">
      <div className="max-w-content mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-px bg-border rounded-2xl overflow-hidden">
          {dict.grid.map((item: { icon: string; title: string; desc: string }, i: number) => (
            <div
              key={i}
              className={`bg-surface p-6 sm:p-7 transition-all duration-700 hover:bg-brand-softer hover:-translate-y-0.5`}
