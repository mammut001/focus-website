      ...
      <div className="max-w-content mx-auto px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-sm text-white/60 hover:text-white transition-colors">{dict.privacy}</a></li>
              <li><a href="#" className="text-sm text-white/60 hover:text-white transition-colors">{dict.terms}</a></li>
              <li>
